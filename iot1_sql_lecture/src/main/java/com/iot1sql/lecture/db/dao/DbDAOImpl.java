...
import com.iot1sql.lecture.common.DataSourceFactory;
...
public class DbDAOImpl extends SqlSessionDaoSupport implements DbDAO {
	...
	public Map<String,Object> runSql(Map<String, String> pm) throws Exception{
		...
		sqlList.add("select * from cal");
		sqlList.add("insert into chat(name, content) values('test','test')");
		sqlList.add("upda cal set num1=5 where calnum=8");
		sqlList.add("delete from cal where calnum=7");
